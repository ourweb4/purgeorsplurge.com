...
class WCVendors_Pro_Admin_Vendor_Controller {
	 ...
	 * @since    1.2.0
	 */
	public function get_pro_user_meta_fields(){ 
		...
		return $fields = apply_filters( 'wcv_custom_user_fields', array( 
			...
			'shipping_address' => array( 
							'title'  	=> __( 'Store Shipping Address' ), 	
							'fields'	=> array( 
	...
	public function add_pro_vendor_meta_fields( $user ) {
		...
		$fields = $this->get_pro_user_meta_fields();
		
		include_once('partials/vendor/wcvendors-pro-user-meta.php'); 
	...
	public function save_pro_vendor_meta_fields( $vendor_id ) {
		...
		$save_fields = $this->get_pro_user_meta_fields();
