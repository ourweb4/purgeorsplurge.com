...
class WCVendors_Pro {
	...
	private function define_admin_hooks() {
		...
		if ( ! $shipping_disabled ) { 
			...
			$this->loader->add_action( 'show_user_profile', 					$this->wcvendors_pro_shipping_controller,  	'store_shipping_override', 11 ); 
			$this->loader->add_action( 'edit_user_profile', 					$this->wcvendors_pro_shipping_controller,  	'store_shipping_override', 11 ); 
			$this->loader->add_action( 'personal_options_update', 				$this->wcvendors_pro_shipping_controller,  	'store_shipping_meta_save', 11 ); 
			$this->loader->add_action( 'edit_user_profile_update', 				$this->wcvendors_pro_shipping_controller,  	'store_shipping_meta_save', 11 ); 
