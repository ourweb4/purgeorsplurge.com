<form action="<?php bp_activity_post_form_action() ?>" method="post" id="swa-whats-new-form" name="swa-whats-new-form">
	...
	<h5>
			<?php printf( __( "What's new %s?", 'buddypress-sitewide-activity-widget' ), bp_get_user_firstname() ) ?>
	...
	<div id="swa-whats-new-content">
		...
		<div id="swa-whats-new-options">
			...
			<?php if ( function_exists('bp_has_groups') && ! bp_is_my_profile() && ! bp_is_group() ) : ?>
				<div id="swa-whats-new-post-in-box">
					...
					<select id="swa-whats-new-post-in" name="swa-whats-new-post-in">
						<option selected="selected" value="0"><?php _e( 'My Profile', 'buddypress-sitewide-activity-widget' ) ?></option>
			...
			<?php endif; ?>
				...
				<input type="submit" name="swa-whats-new-submit" id="swa-whats-new-submit" value="<?php _e( 'Post Update', 'buddypress-sitewide-activity-widget' ) ?>" />
			</div>
