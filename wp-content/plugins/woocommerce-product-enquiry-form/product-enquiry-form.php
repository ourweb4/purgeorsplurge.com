...
if ( is_woocommerce_active() ) {
			...
			class WC_Product_Enquiry_Form {
			    ...
			    function add_product_enquiry_tab( $tabs = array() ) {
				    ...
				    $tabs['product_enquirey'] = array(
						'title'    => apply_filters( 'product_enquiry_tab_title', __( 'Product Inquiry', 'wc_enquiry_form' ) ),
						'priority' => 40,
	...
	$shop_name = WCV_Vendors::is_vendor( $vendor_id )
			? sprintf( '%s', WCV_Vendors::get_vendor_shop_name( $vendor_id ) )
			: get_bloginfo( 'name' );
...
//echo 'page name: ' . $pagename;
			...
			?>
						...
						<a href="https://www.purgeorsplurge.com/my-messages/?fepaction=newmessage&to=<?php echo $shop_name;?>&subject=<?php echo $pagename;?>" style="padding:4px;background-color:#999; color:#fff;margin: 1px, solid thin #000; font-size:16px !important;">Message Seller</a>
