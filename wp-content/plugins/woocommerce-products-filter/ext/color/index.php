...
final class WOOF_EXT_COLOR extends WOOF_EXT
{
    ...
    public function init()
    {
        ...
        /*
          ...
          'checked_color_img' => array(
          'title' => __('Image for checked color type checkbox', 'woocommerce-products-filter'),
          'tip' => __('Image for color checkboxes when its checked. Better use png. Size is: 25x25 px.', 'woocommerce-products-filter'),
          'type' => 'image'
          )
          );
         */
