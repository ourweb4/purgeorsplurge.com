		...
		if ( $file == WC_EMAIL_CONTROL_PLUGIN_BASENAME ) {
			...
			if ( ! $purchase_code ) {
				...
				$row_meta = array(
					...
					'support' => '<a class="cx-plugin-update-row-meta-change-purchase-code" href="' . esc_url( "?{$this->slug}-purchase-code" ) . '" title="' . esc_attr( __( '', 'email-control' ) ) . '">' . __( 'Edit registration', 'email-control' ) . '</a>',
