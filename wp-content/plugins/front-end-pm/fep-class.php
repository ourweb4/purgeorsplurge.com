...
/******************************************MAIN DISPLAY BEGIN******************************************/
   ...
   function main_shortcode_output()
	...
	$parent_id = ( isset( $_POST['parent_id'] ) ) ? absint( $_POST['parent_id'] ): 0;
        ...
        $MgsTo .=" <b>Begin typing the name of the vendor - ".$_GET['to']." - below to see a list of matches</b><br><input type='hidden' id='fep-message-to' name='message_to' autocomplete='off' value='$message_to' />
        ...
        <input type='text' name='message_title' value='".$_GET['subject']."' maxlength='65' value='$message_title' /><br/>";
		ob_start();
