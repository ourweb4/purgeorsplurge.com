												...
												<td class="forminp forminp-select">
													...
													<?php
														...
														$relation_params = array(
															...
															'subcategories' => __( 'Keep parent and child terms', 'prdctfltr' ),
...
/*					'prdctfltr_force_categories' => array(
					...
					'section_noneajax_title' => array(
						...
						'name' => __( 'Product Filter Product Archives Settings With Disabled AJAX', 'prdctfltr' ),

						'type' => 'title',

						'desc' => __( 'Special settings for shop and product archive pages with disabled AJAX.', 'prdctfltr' ),
					...
					'prdctfltr_remove_single_redirect' => array(
						...
						'name' => __( 'Singe Product Redirect', 'prdctfltr' ),
