...
function dhvc_woo_orderby($orderby){
	...
	echo apply_filters('dhvc_woo_orderby', ob_get_clean());

}



function dhvc_result_count($r){
	...
	echo apply_filters('dhvc_result_count', ob_get_clean());
...
function dhvc_woo_params(){
	...
	return array(
		...
		array (
				...
				"heading" => __ ( "Show Pagination", DHVC_WOO ),
